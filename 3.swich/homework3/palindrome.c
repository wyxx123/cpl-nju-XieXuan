...
//  if(one_back_crime[i]!= 63)
//    sub_array[i]= one_back_crime[i]
//  else if(one_back_crime[size - i -1]!= 63)
//    sub_array[i]= one_back_crime[size - i -1]
//  else
...
#define SWAP(a, b) \
	...
	//first method to swap two numbers
...
int main(void)
{
	...
	SWAP(num1, num2)
	num1 ^= num2 ^= num1 ^= num2;
	//not good codes, but good thought.
	printf("%d\n", num1, num2);
